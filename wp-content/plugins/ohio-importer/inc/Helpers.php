...
class Helpers {
	...
	public static function download_import_files( $import_file_info, $type = 'wpbakery' ) {
		...
		if ( !empty( $import_file_info['import_file_url'] ) ) {
			$import_file_info['import_file_url'] = str_replace( 'https://demo.clbthemes.com/', get_site_url() . '/wp-content/plugins/ohio-importer/demos/', $import_file_info['import_file_url'] );
		}
		if ( !empty( $import_file_info['import_elementor_file_url'] ) ) {
			$import_file_info['import_elementor_file_url'] = str_replace( 'https://demo.clbthemes.com/', get_site_url() . '/wp-content/plugins/ohio-importer/demos/', $import_file_info['import_elementor_file_url'] );
		}
		if ( !empty( $import_file_info['import_widget_file_url'] ) ) {
			$import_file_info['import_widget_file_url'] = str_replace( 'https://demo.clbthemes.com/', get_site_url() . '/wp-content/plugins/ohio-importer/demos/', $import_file_info['import_widget_file_url'] );
		}
		if ( !empty( $import_file_info['import_options_file_url'] ) ) {
			$import_file_info['import_options_file_url'] = str_replace( 'https://demo.clbthemes.com/', get_site_url() . '/wp-content/plugins/ohio-importer/demos/', $import_file_info['import_options_file_url'] );
		}
		if ( !empty( $import_file_info['import_sliders_file_url'] ) ) {
			$import_file_info['import_sliders_file_url'] = str_replace( 'https://demo.clbthemes.com/', get_site_url() . '/wp-content/plugins/ohio-importer/demos/', $import_file_info['import_sliders_file_url'] );
		}
		// / CUSTOM CODE
